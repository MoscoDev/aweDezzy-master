                  ...
                  <Menu>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">
                          <CreditCardTwoTone twoToneColor="#40196D" /> kuda card
                        </Space>
                      </NavLink>
                    </Menu.Item>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">
                          <DollarCircleTwoTone twoToneColor="#40196D" /> Spend
                        </Space>
                      </NavLink>
                    </Menu.Item>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">
                          <WalletTwoTone twoToneColor="#40196D" /> Save
                        </Space>
                      </NavLink>
                    </Menu.Item>
                    ...
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">
                          <ScheduleTwoTone twoToneColor="#40196D" /> Budget
                        </Space>
                      </NavLink>
                    </Menu.Item>
                    ...
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">
                          <BankTwoTone twoToneColor="#40196D" /> Borrow
                        </Space>
                      </NavLink>
                    </Menu.Item>
                  </Menu>
              ...
              <Dropdown
                overlay={
                  <Menu>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">Blog</Space>
                      </NavLink>
                    </Menu.Item>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">Press</Space>
                      </NavLink>
                    </Menu.Item>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">Join Our Team</Space>
                      </NavLink>
                    </Menu.Item>
                    <Menu.Item className="dropdown">
                      <NavLink to="/" className="dropdown">
                        <Space size="large">About</Space>
                      </NavLink>
                    </Menu.Item>
                  </Menu>
                }
      ...
      <div className="right">
        <Space size="large">
          ...
          <NavLink to="/signup" className="link">
            <Button className="navButtons" shape="round" size="large">
              Register
            </Button>
          </NavLink>
          <MenuOutlined
          ...
          <>
            ...
            >
              ...
              <NavLink to="/" className="lin" onClick={handleCancel}>
                Features
              </NavLink>
              <NavLink to="/" className="lin" onClick={handleCancel}>
                Company
              </NavLink>
              <NavLink to="/faq" className="lin" onClick={handleCancel}>
                <Space size="small">FAQs</Space>
              </NavLink>
              <NavLink to="/login" className="lin" onClick={handleCancel}>
                <Button className="navButto" type="" shape="round" size="large" onClick={handleCancel}>
                  Sign In
                </Button>
              </NavLink>
              <p>
                <NavLink to="/signup" onClick={handleCancel} className="lin">
                  <Button className="navButto" shape="round" size="large">
                    Register
                  </Button>
                </NavLink>
              </p>
