...
import emoji from "../images/download-removebg-preview.png"
...
const columns = [
  ...
  {
    title: <h2 style={{ fontWeight: "900", color: "#40196D" }}>Other Banks</h2>,
    dataIndex: "age",
    key: "age",
  },
  {
...
const data = [
  {
    ...
    age: (
      <Space size="middle">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <circle cx="8" cy="8" r="8" fill="#DBDCE0"></circle>
          <rect
            x="3"
            y="6.99902"
            width="10"
    ...
    address: (
      <Space size="middle">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <circle cx="8" cy="8" r="8" fill="#DFE3FF"></circle>
          <path
            d="M6.39745 9.9415L10.9134 5.21316C11.1848 4.92895 11.625 4.92895 11.8964 5.21316C12.1679 5.49738 12.1679 5.9582 11.8964 6.24242L6.39745 12L3.20359 8.65592C2.93214 8.3717 2.93214 7.91089 3.20359 7.62667C3.47504 7.34245 3.91515 7.34245 4.18661 7.62667L6.39745 9.9415Z"
            fill="#40196D"
          ></path>
        </svg>
  ...
  },
  {
    ...
    age: (
      <Space size="middle">
        ...
        <span><img src={emoji} width={25} alt="" /></span>
      </Space>
    ),
    address: (
      <Space size="middle">
  ...
  },
  {
    ...
    address: (
      <Space size="middle">
        ...
        <span>Free and instant alerts</span>
      </Space>
    ),
  },
];
...
export default function Tables() {
  return (
    <div style={{paddingBottom:"100px"}}>
      <h1 className="Table-header">Choose the freedom you need.</h1>
      <div className="Table" style={{ width: "75%", margin: "0 auto" }}>
